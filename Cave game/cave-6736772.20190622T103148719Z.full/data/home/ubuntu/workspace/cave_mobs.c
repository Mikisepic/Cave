...
void defence(int *hp, int *dmg, int *block, int *hp1, int *dmg1, int *block1);
...
OPTION: printf("Its your turn mortal, what will you do? [A/D]\n");
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &slime.hp, &slime.dmg, &slime.block);
            printf("Your hp is %i, and the enemy's is %i\n", hero.hp, slime.hp);
            sleep(1);
        }
...
void armorMob()
{
    ...
    do
    {
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &hallowArmor.hp, &hallowArmor.dmg, &hallowArmor.block);
            printf("Your hp is %i, and the enemy's is %i, enemy's block is %i\n", hero.hp, hallowArmor.hp, hallowArmor.block);
        }
...
void hugeRatMob()
{
    ...
    do
    {
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &hugeRat.hp, &hugeRat.dmg, &hugeRat.block);
            printf("Your hp is %i, and the enemy's is %i\n", hero.hp, hugeRat.hp);
            sleep(1);
        }
...
void bossFightWorm()
{
    ...
    do
    {
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &bossWorm.hp, &bossWorm.dmg, &bossWorm.block);
            printf("Your hp is %i, and the enemy's is %i\n", hero.hp, bossWorm.hp);
        }
...
void golemMob()
{
    ...
    do
    {
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &golem.hp, &golem.dmg, &golem.block);
            printf("Your hp is %i, and the enemy's is %i (block: %i)\n", hero.hp, golem.hp, golem.block);
            sleep(1);
        }
...
OPTION: printf("Its your turn mortal, what will you do? [A/D]\n");
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &cultist.hp, &cultist.dmg, &cultist.block);
            printf("Your hp is %i, and the cultist's is %i\n", hero.hp, cultist.hp);
            sleep(1);
        }
...
OPTION: printf("Its your turn mortal, what will you do? [A/D]\n");
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &heavyArmor.hp, &heavyArmor.dmg, &heavyArmor.block);
            printf("Your hp is %i, and the enemy's is %i, enemy's block is %i\n", hero.hp, heavyArmor.hp, heavyArmor.block);
            sleep(2);
        }
...
OPTION: printf("Its your turn mortal, what will you do? [A/D]\n");
        ...
        {
            defence(&hero.hp, &hero.dmg, &hero.def, &shadow.hp, &shadow.dmg, &shadow.block);
            printf("Your hp is %i, and the enemy's is %i, enemy's block is %i\n", hero.hp, shadow.hp, shadow.block);
            sleep(2);
        }
...
void special(int *hp, int *dmg, int *block, int *hp1, int *dmg1, int *block1)
{
    ...
    else if (strcmp(item2, "sacraficialDagger") == 0)
    {
        *dmg += 15;
