...
export C9_FULLNAME='letonus'
export C9_HOSTNAME='cave-letonus.c9users.io'
export C9_EMAIL='igniukas.ignas@gmail.com'
export C9_USER='letonus'
export C9_PROJECT='cave'
export C9_PID='6736772'
export C9_UID='2036486'
